...
(function() {
  ...
  $(document).ready(function() {
    return EmailWidget.create();
  });

  EmailWidget = (function() {
    function EmailWidget() {}

    EmailWidget.create = function() {
      var elements;
      elements = $('.email_widget');
      return _.each(elements, function(element) {
        var domain, name;
        element = $(element);
        name = element.data('name');
        domain = element.data('domain') || 'broken-circle-productions.com';
        return element.text(name + "@" + domain);
      });
    };
...
$(document).ready(function(){
    ...
    $('.poster_container').height( page_height - nav_height )
});
