...
(function() {
  var carousel, carousel_index, images_list, load_carousel, log, set_carousel_index, set_next, set_prev;
  ...
  images_list = function() {
    return carousel().children('img.carousel_image');
  };
...
(function() {
  $(document).on('click', '.modal_closer', function() {
    var e;
    e = $(this);
    return e.parents('.reveal-modal').foundation('reveal', 'close');
  });
...
(function() {
  $(document).on('click', '#video_opener', function() {
    ...
    return _V_("concept_video").play();
  });

  $(document).ready(function() {
    return $(document).on('opened.fndtn.reveal', '#video_modal', function() {
